...
var AppService = /** @class */ (function () {
    function AppService(http) {
        ...
        this.url = 'http://api.issuetrackingtool.reifordproject.site';
        ...
        this.getAllUsers = function () {
            ...
            return _this.http.get(_this.url + "/api/v1/users/view/all?authToken=" + authToken);
        };
    } // end constructor  
    AppService.prototype.editUser = function (userId, userDetail) {
        var authToken = ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_3__["Cookie"].get('authtoken');
        return this.http.put(this.url + "/api/v1/users/" + userId + "/edit?authToken=" + authToken, userDetail);
    };
    AppService.prototype.getSingleUser = function (email) {
        var authToken = ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_3__["Cookie"].get('authtoken');
    ...
    AppService.prototype.getvalidateemail = function (email) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]()
            .set('email', email);
        return this.http.post(this.url + "/api/v1/users/forgotpassword/email", params);
    };
    AppService.prototype.resetPassword = function (email, password) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]()
            .set('password', password)
            .set('email', email);
        return this.http.post(this.url + "/api/v1/users/forgotpassword/reset", params);
    };
    AppService.prototype.getOTP = function (OTP, email) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]()
            .set('email', email)
            .set('OTP', OTP);
        return this.http.post(this.url + "/api/v1/resetpassword", params);
    };
    AppService.prototype.createIssue = function (issueData) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]()
    ...
    AppService.prototype.getAllComment = function (trackingId) {
        var authToken = ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_3__["Cookie"].get('authtoken');
        return this.http.get(this.url + "/api/v1/comment/view/all/" + trackingId + "?authToken=" + authToken);
    };
    AppService.prototype.addNotification = function (title, changes, trackingId) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]()
            .set('title', title)
            .set('changes', changes)
            .set('trackingId', trackingId)
    ...
    AppService.prototype.getNotifications = function () {
        var authToken = ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_3__["Cookie"].get('authtoken');
    ...
    AppService.prototype.addAssignee = function (trackingId, email) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]()
            .set('email', email)
            .set('trackingId', trackingId)
            .set('authToken', ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_3__["Cookie"].get('authtoken'));
    ...
    AppService.prototype.deleteNotifications = function (trackingId, email) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpParams"]()
            .set('email', email)
            .set('trackingId', trackingId)
            .set('authToken', ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_3__["Cookie"].get('authtoken'));
...
var HomeRouteGuardService = /** @class */ (function () {
    function HomeRouteGuardService(router) {
        this.router = router;
    }
    HomeRouteGuardService.prototype.canActivate = function (route) {
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(toastr, appService, router, _route) {
        var _this = this;
        this.toastr = toastr;
    ...
    HomeComponent.prototype.getAllNotifications = function () {
        var _this = this;
        this.appService.getNotifications().subscribe(function (data) {
            _this.allNotifications = data["data"];
            if (_this.allNotifications) {
                _this.notificationLength = _this.allNotifications.length;
            }
        }, function (error) {
    ...
    HomeComponent.prototype.clearNotification = function (trackingId, email) {
    ...
    HomeComponent.prototype.GetAllIssue = function (field, type) {
        var _this = this;
        this.appService.getSortedIssue(field, type).subscribe(function (data) {
            _this.allIssue = data["data"];
            _this.srch = true;
            return _this.allIssue;
        }, function (error) {
            _this.toastr.error(error.error.message);
        });
    }; // end of GetAllIssue
    HomeComponent.prototype.searchIssue = function () {
        var _this = this;
        if (this.searchBox == null || this.searchBox == undefined || this.searchBox == '') {
            this.GetAllIssue(this.field, this.type);
            return this.searchBox;
        }
        this.appService.getSearchIssues(this.searchBox).subscribe(function (data) {
            _this.allIssue = data["data"];
            _this.srch = false;
            return _this.allIssue;
        }, function (error) {
    ...
    HomeComponent.prototype.sortedData = function (field) {
        if (this.type == 1) {
            this.type = -1;
        }
        else {
...
var CreateComponent = /** @class */ (function () {
    function CreateComponent(_route, router, appService, toastr, location) {
        var _this = this;
        this._route = _route;
        this.router = router;
        this.appService = appService;
    ...
    CreateComponent.prototype.createIssue = function () {
        var _this = this;
        if (this.issueTitle == null || this.issueTitle == undefined || this.issueTitle == '') {
            ...
            this.appService.createIssue(issueData).subscribe(function (data) {
                _this.toastr.success('Issue Creates successfully', 'Success!');
    ...
    CreateComponent.prototype.goBackToPreviousPage = function () {
        this.location.back();
    };
...
var EditComponent = /** @class */ (function () {
    function EditComponent(_route, router, appService, toastr, location) {
        var _this = this;
        this._route = _route;
        this.router = router;
        this.appService = appService;
    ...
    EditComponent.prototype.ngOnInit = function () {
        var _this = this;
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
        this.appService.getSingleIssue(trackingId).subscribe(function (data) {
            _this.currentIssue = data["data"];
            _this.title = _this.currentIssue.title;
            _this.previousAssignee = _this.currentIssue.assigned;
        }, function (error) {
            // console.log(error.error.message)
        });
        this.getAll();
    };
    EditComponent.prototype.editIssue = function () {
        var _this = this;
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
        this.appService.editIssue(this.currentIssue.trackingId, this.currentIssue)
            .subscribe(function (data) {
            if (_this.currentIssue.assigned != ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_6__["Cookie"].get('email') && _this.previousAssignee != _this.currentIssue.assigned) {
                _this.appService.addNotification(_this.title, 'assignee', trackingId).subscribe();
            }
            else {
                _this.appService.addNotification(_this.title, 'modification', trackingId).subscribe();
            }
            _this.toastr.success('Edited successfully!');
            _this.router.navigate(['/view', _this.currentIssue.trackingId]);
        }, function (error) {
            // console.log(error.error.message);
        });
    }; // end edit
    EditComponent.prototype.getAll = function () {
        var _this = this;
        this.appService.getAllUsers().subscribe(function (data) {
            _this.assignee = data["data"];
        }, function (error) {
            // console.log(error.error.message)
        });
    };
    EditComponent.prototype.goBackToPreviousPage = function () {
        this.location.back();
    };
...
/* harmony import */ var _syncfusion_ej2_angular_richtexteditor__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @syncfusion/ej2-angular-richtexteditor */ "./node_modules/@syncfusion/ej2-angular-richtexteditor/@syncfusion/ej2-angular-richtexteditor.es5.js");
...
module.exports = "@import url('https://fonts.googleapis.com/css?family=Montserrat|Open+Sans');\r\n.container {\r\n  width: auto;\r\n  padding: 0 25px;\r\n}\r\nbody, html {\r\n    font-family: 'Open Sans', sans-serif;\r\n    font-family: 'Montserrat', sans-serif;\r\n    background: #0a583173;\r\n    opacity: 0.9;\r\n}\r\ninput[type=\"text\"], #state, #assigned {\r\n    font-size: 1.6rem;\r\n    color: #010100;\r\n    height:40px;\r\n    padding-left: 3rem;\r\n    border-radius: 2rem;\r\n}\r\n#summary {\r\n    font-size: 1.6rem;\r\n    border-radius: 1rem;\r\n}\r\n#comment {\r\n    font-size: 1.6rem;\r\n    height:100px;\r\n    border-radius: 1rem;\r\n}\r\n#comments {\r\n    font-family: 'Open Sans', sans-serif;\r\n    font-family: 'Montserrat', sans-serif;\r\n    font-size: 1.6rem;\r\n    border-radius: 1rem;\r\n    padding-left: 2rem;\r\n    padding-right: 2rem;\r\n    color: #010100;\r\n    overflow: auto;\r\n    resize: auto;\r\n    outline: none;\r\n}\r\n.text-white {\r\n    color: #fff!important;\r\n}\r\n.label{\r\n    font-size: 1.6rem;\r\n    color: #010100;\r\n    line-height: 5px;\r\n}\r\n.has-error input[type=\"text\"], .has-error textarea, .has-error select {\r\n    border: 1px solid #ff0400;\r\n}\r\n\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ViewComponent = /** @class */ (function () {
    function ViewComponent(toastr, appService, router, _route, location) {
        var _this = this;
        this.toastr = toastr;
        this.appService = appService;
        this.router = router;
    ...
    ViewComponent.prototype.ngOnInit = function () {
        ...
        this.appService.getSingleIssue(trackingId).subscribe(function (data) {
            if (data.status == 404) {
                _this.currentIssue = false;
            }
            else {
                _this.currentIssue = data["data"];
                if (_this.currentIssue) {
                    _this.title = _this.currentIssue.title;
                }
            }
        }, function (error) {
    ...
    ViewComponent.prototype.clearNotification = function () {
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
    ...
    ViewComponent.prototype.getAll = function () {
        var _this = this;
        this.appService.getAllUsers().subscribe(function (data) {
            _this.assignee = data["data"];
        }, function (error) {
    ...
    ViewComponent.prototype.getAllComments = function () {
        var _this = this;
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
        this.appService.getAllComment(trackingId).subscribe(function (data) {
            _this.allComment = data["data"];
            if (_this.allComment) {
                _this.commentLength = _this.allComment.length;
            }
        }, function (error) {
            // console.log(error.error.message)
        });
    };
    ViewComponent.prototype.assigning = function () {
        var _this = this;
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
        this.appService.addAssignee(trackingId, this.currentIssue.assigned).subscribe(function (data) {
            if (data.status == 200) {
                _this.appService.addNotification(_this.title, 'assignee', trackingId).subscribe();
    ...
    ViewComponent.prototype.addWatcher = function () {
        var _this = this;
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
        if (trackingId == null || trackingId == undefined || trackingId == '') {
            ...
            this.appService.addWatcher(trackingId).subscribe(function (data) {
                if (data.status == 200) {
                    _this.appService.addNotification(_this.title, 'watcher', trackingId).subscribe();
                    _this.toastr.success(data.message);
                }
                _this.getAllWatcher();
            }, function (error) {
                // console.log(error.error.message);
                _this.toastr.error("Some error occured while adding");
            });
        }
    }; // end addWatcher function
    ViewComponent.prototype.removeWatcher = function () {
        var _this = this;
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
        if (trackingId == null || trackingId == undefined || trackingId == '') {
            ...
            this.appService.removeWatcher(trackingId).subscribe(function (data) {
                if (data.status == 200) {
                ...
                // console.log(error.error.message);
                _this.toastr.error("Some error occured while removing");
            });
        }
    }; // end removeWatcher function
    ViewComponent.prototype.getAllWatcher = function () {
        var _this = this;
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
        if (trackingId == null || trackingId == undefined || trackingId == '') {
            this.toastr.warning('Issue Id is Missing!');
            ...
            this.appService.getWatchers(trackingId).subscribe(function (data) {
                _this.watcher = data["data"];
            }, function (error) {
                // console.log(error);
                // this.toastr.error(error.error.message);
                _this.toastr.error("Some error occured while get watchers list");
            });
        }
    }; // end getAllWatcher function
    ViewComponent.prototype.editIssue = function () {
        var _this = this;
        var email = ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_6__["Cookie"].get('email');
        var userName = ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_6__["Cookie"].get('userName');
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
        if (trackingId == null || trackingId == undefined || trackingId == '') {
            this.toastr.warning('Issue Id is Required!');
        }
            ...
            this.appService.getSingleIssue(trackingId).subscribe(function (data) {
                if (data.data.assigned == email || data.data.email == email || data.data.creator == userName) {
                    _this.router.navigate(['/edit', trackingId]);
                }
                else {
                    _this.toastr.error("The issue is not assigned to you or reported by you, So you cannot edit");
                }
                _this.getAllWatcher();
            }, function (error) {
                // console.log(error.error.message);
                _this.toastr.error("Some error occured while saving");
            });
        }
    }; // end editIssue function
    ViewComponent.prototype.deleteThisIssue = function () {
        var _this = this;
        var email = ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_6__["Cookie"].get('email');
        var trackingId = this._route.snapshot.paramMap.get('trackingId');
        if (trackingId == null || trackingId == undefined || trackingId == '') {
            ...
            this.appService.getSingleIssue(trackingId).subscribe(function (data) {
                if (data.data.email == email) {
                    var confirmed = confirm("Are your sure you want to delete this Issue");
                    if (confirmed) {
                        _this.appService.deleteIssue(trackingId).subscribe(function (data) {
                            if (data.status == 200) {
                                _this.toastr.success(data.message);
                                _this.router.navigate(['/home']);
                            }
                            ...
                            // console.log(error.error.message);
                            _this.toastr.error("Some error occured while deleting");
                        });
                    }
                }
                else {
                    _this.toastr.error("You cannot delete this issue as it was not reported by you");
                }
                _this.getAllWatcher();
            }, function (error) {
                // console.log(error.error.message);
                _this.toastr.error("Some error occured while get the issue");
            });
        }
    }; // end deleteThisIssue function
    ViewComponent.prototype.commenting = function () {
        var _this = this;
        if (this.commentBox == null || this.commentBox == undefined || this.commentBox == '') {
            this.toastr.warning('Please Enter Something');
        }
        else {
            var trackingId_1 = this._route.snapshot.paramMap.get('trackingId');
            this.appService.createComment(this.commentBox, trackingId_1).subscribe(function (data) {
                if (data.status == 200) {
                    _this.commentBox = "";
                    _this.toastr.success(data.message);
                    _this.appService.addNotification(_this.title, 'comment', trackingId_1).subscribe();
...
var ForgotPasswordComponent = /** @class */ (function () {
    function ForgotPasswordComponent(appService, router, toastr) {
        ...
        this.checkEmail = function () {
            if (!_this.email) {
                _this.toastr.warning('Please enter your email');
            }
            else {
                _this.appService.getvalidateemail(_this.email).subscribe(function (apiResponse) {
                    if (apiResponse.status === 200) {
                        _this.validation = true;
                        _this.otp = Math.random().toString(10).substring(2, 8).toLocaleUpperCase();
                        _this.appService.getOTP(_this.otp, _this.email).subscribe(function (apiResponse) {
                            if (apiResponse.status === 200) {
                                _this.toastr.success(apiResponse.message);
                            }
                            else {
        ...
        this.resetPassword = function () {
            if (!_this.password) {
                _this.toastr.warning('Please enter your password');
            }
            else if (_this.confirm == null || _this.confirm == undefined) {
                _this.toastr.warning('Confirm password is empty');
            }
            else {
                if (_this.confirm != _this.password) {
                    _this.toastr.warning('Password does not match!');
                }
                else {
                    if (_this.getotp == _this.otp) {
                        _this.appService.resetPassword(_this.email, _this.password).subscribe(function (apiResponse) {
                            if (apiResponse.status === 200) {
                                _this.toastr.success(apiResponse.message);
                                _this.router.navigate(['/login']);
                                _this.validation = null;
                            }
                            else {
                                _this.toastr.error(apiResponse.message);
                                _this.validation = true;
                        ...
                        _this.toastr.warning('Please check the OTP');
                    }
                }
            }
    ...
    function SignupComponent(appService, router, toastr, vcr) {
        ...
        this.signupFunction = function () {
            if (!_this.firstName) {
                ...
                _this.toastr.warning('Enter your place');
            }
            else if (!_this.gender || _this.gender == 'Gender') {
                _this.toastr.warning('enter Gender');
            }
            else if (!_this.email) {
                _this.toastr.warning('enter email');
            }
                ...
                if (_this.password != _this.confirm) {
                    ...
                    _this.toastr.warning('password missmatch');
                }
                else {
                    var data = {
...
var UserDetailsComponent = /** @class */ (function () {
    function UserDetailsComponent(toastr, appService, router, _route) {
        this.toastr = toastr;
        this.appService = appService;
        this.router = router;
        this._route = _route;
    ...
    UserDetailsComponent.prototype.getdetails = function (email, firstname, lastname) {
        var e_1, _a, e_2, _b, e_3, _c;
        var issueIDArray = [];
        var issuewatcherArray = [];
        var issueCreatedArray = [];
        var issueAssignedArray = [];
        if (this.allwatchers) {
            var count = 0;
            try {
                for (var _d = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.allwatchers), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var i = _e.value;
                    if (i.email == email) {
        ...
        if (this.allassignee) {
            ...
            var count2 = 0;
            try {
                for (var _f = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.allassignee), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var i = _g.value;
                    if (i.email == email) {
                        count1++;
                    ...
                    try {
                        for (var issueIDArray_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](issueIDArray), issueIDArray_1_1 = issueIDArray_1.next(); !issueIDArray_1_1.done; issueIDArray_1_1 = issueIDArray_1.next()) {
                            var t = issueIDArray_1_1.value;
                            if (i.trackingId == t) {
                        ...
                        try {
                            if (issueIDArray_1_1 && !issueIDArray_1_1.done && (_c = issueIDArray_1.return)) _c.call(issueIDArray_1);
                        }
    ...
    UserDetailsComponent.prototype.getALlUsers = function () {
        var _this = this;
        this.appService.getAllUsers().subscribe(function (data) {
    ...
    UserDetailsComponent.prototype.getAllWatchers = function () {
        var _this = this;
        this.appService.getAllWatchers().subscribe(function (data) {
            _this.allwatchers = data["data"];
        }, function (error) {
            //console.log("some error occured");
            // console.log(error.error.message)
        });
    }; // end of getAllWatchers
    UserDetailsComponent.prototype.getAllAssignee = function () {
        var _this = this;
        this.appService.getAllIssue('', '').subscribe(function (data) {
            _this.allassignee = data["data"];
        }, function (error) {
            //console.log("some error occured");
            // console.log(error.error.message)
        });
    ...
    UserDetailsComponent.prototype.openNav = function () {
        document.getElementById("mySidenav").style.width = "250px";
    };
    UserDetailsComponent.prototype.closeNav = function () {
...
var UserProfileComponent = /** @class */ (function () {
    function UserProfileComponent(_route, router, appService, toastr, location) {
        this._route = _route;
        this.router = router;
        this.appService = appService;
        this.toastr = toastr;
    ...
    UserProfileComponent.prototype.getAllUser = function () {
        var _this = this;
        this.appService.getSingleUser(ng2_cookies_ng2_cookies__WEBPACK_IMPORTED_MODULE_6__["Cookie"].get('email')).subscribe(function (data) {
    ...
    UserProfileComponent.prototype.goBackToPreviousPage = function () {
        this.location.back();
    };
...
module.exports = __webpack_require__(/*! /media/fordy/1AFCB2FCFCB2D0ED/project 1/project1/src/main.ts */"./src/main.ts");
